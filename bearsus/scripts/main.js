...
'use strict';
{
  if (window["C3_IsSupported"]) {
    ...
    window["c3_runtimeInterface"] = new self.RuntimeInterface({
      ...
      engineScripts: ["https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/bearsus/scripts/c3runtime.js"],
      projectScripts: [
        ["scripts/project/scriptsInEvents.js"]
      ],
      mainProjectScript: "",
      scriptFolder: "https://cdn.jsdelivr.net/gh/bubbls/UGS-Assets@main/bearsus/",
